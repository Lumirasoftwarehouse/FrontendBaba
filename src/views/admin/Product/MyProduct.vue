...
export default {
  ...
  methods: {
    ...
    async updateSosial() {
      try {
        ...
        const response = await axios.post(
          `${import.meta.env.VITE_API_ENDPOINT}/product/margin-product`,
          formData,
          {
            headers: {
    ...
    async fetchDataProduct() {
      try {
        ...
        const response = await axios.get(
          `${import.meta.env.VITE_API_ENDPOINT}/product/list-product`,
          {
            headers: {
              Authorization: "Bearer " + sessionStorage.getItem("token"),
            },
    ...
    deleteProduct(id) {
      this.ready = false;
      axios
        .delete(`${import.meta.env.VITE_API_ENDPOINT}/product/delete-product/${id}`, 
        {
          headers: {
